...
var Command = (function () {
  ...
  _createClass(Command, [{
    ...
    value: function runCommand() /*command, args, done*/{
      ...
      var _normalizeRunArguments = normalizeRunArguments.apply(undefined, arguments);

      var _normalizeRunArguments2 = _slicedToArray(_normalizeRunArguments, 3);

      var commandName = _normalizeRunArguments2[0];
      var args = _normalizeRunArguments2[1];
      var done = _normalizeRunArguments2[2];
